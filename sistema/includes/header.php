...
<head>
	...
	<link rel="icon" href="http://localhost/radianttech/sistema/favicon/logo.ico" type="image/x-icon">
			...
			<div id="content">
				...
				<nav class="navbar navbar-expand navbar-light bg-primary text-white topbar mb-4 static-top shadow">
					...
					<div class="input-group">
						<h6 style="font-weight: bold; font-style: italic; font-size: 30px;">Sistema de Ventas - Tecnología</h6>
					</div>
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow">
							<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<!-- Ícono de usuario a la izquierda del nombre -->
				...
				<script>
					// Confirmación al hacer clic en "Salir"
					document.getElementById('logoutButton').addEventListener('click', function(e) {
						e.preventDefault(); // Prevenir que el enlace haga la acción por defecto
						Swal.fire({
							title: '¿Estás seguro?',
							text: "¡Seguro que quieres salir del sistema?",
							icon: 'warning',
							...
							if (result.isConfirmed) {
								window.location.href = 'salir.php'; // Redirigir al script de salir
							}
						});
					});
				</script>
