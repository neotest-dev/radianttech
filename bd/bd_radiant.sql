...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-12-2024 a las 22:48:12
...
(1, 71593668, 'Jafet Florián', 972874719, 'Salaverry #256', 2),
(2, 18282828, 'Diego Gutierrez', 920210120, 'Trujillo #345', 1),
(3, 42676584, 'Luis Torres', 921012012, 'Porvenir #897', 1),
(4, 99129219, 'Jhan Asto', 992645621, 'España #400', 1),
(5, 18024636, 'Kiara Mendez', 991221821, 'Fujimori #001', 1);
...
(1, 2127483642, 'Radiant Tech', 'Negocio Tecnológico', 972874719, 'radianttech@gmail.com', 'Trujillo - Perú', 18.00);
...
(1, 'LAPTOP HELIOS NEO 16', 1, 6278.12, 2, 1),
(2, 'LAPTOP IDEAPAD 1 15IAU7 ', 1, 1488.00, 9, 1),
(3, 'MOUSE LOGITECH G203', 1, 78.99, 16, 1),
(4, 'MOUSE LOGITECH G PRO X', 2, 393.99, 21, 1),
(5, 'MONITOR ASUS VG27AQ3A', 2, 1092.99, 7, 1);
...
(1, 'Rstore', '20123456789', 933527217, 'Lima', 2),
(2, 'Coporación Pegasus 5000 SAC', '20456789123', 921920120, 'Lima - Callao', 1);
...
(1, 'Jafet Florián', 'jafet@gmail.com', 'jafet', '99dc59c4a89989ffe3a54251382873ed', 1),
(2, 'Julio Azabache', 'julio@gmail.com', 'julio', 'c027636003b468821081e281758e35ff', 2);
